...
class _RetailerRegistrationPageState extends State<RetailerRegistrationPage> {
  ...
  Future<File?> _compressImage(File imageFile) async {
    try {
      ...
      // Print compression details (optional)
  ...
  String? _validateStreetAddress(String? value) {
    ...
    // Regex to allow letters, numbers, spaces, commas, and hyphens
  ...
  void _submitForm() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      bool success = await provider.submitRetailerRegistration(
        ...
        profileImage: _profileImage, // This is now optional
